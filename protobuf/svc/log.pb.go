...
var file_protobuf_svc_log_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x2a, 0x31, 0x0a, 0x05, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x12,
	...
	0x0a, 0x05, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x03, 0x2a, 0xab, 0x03, 0x0a, 0x09, 0x4f, 0x70,
...
var (
	...
	file_protobuf_svc_log_proto_rawDescData = file_protobuf_svc_log_proto_rawDesc
)

func file_protobuf_svc_log_proto_rawDescGZIP() []byte {
	file_protobuf_svc_log_proto_rawDescOnce.Do(func() {
		file_protobuf_svc_log_proto_rawDescData = protoimpl.X.CompressGZIP(file_protobuf_svc_log_proto_rawDescData)
	})
...
func file_protobuf_svc_log_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_protobuf_svc_log_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Logs); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_protobuf_svc_log_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_protobuf_svc_log_proto_rawDesc = nil
