...
type Logs struct {
	...
	ServiceErrorCode *int32                 `protobuf:"varint,12,opt,name=ServiceErrorCode,proto3,oneof" json:"ServiceErrorCode,omitempty"`                 // 业务错误码
	ExceptionInfo    []byte                 `protobuf:"bytes,13,opt,name=ExceptionInfo,proto3,oneof" json:"ExceptionInfo,omitempty"`                        // 异常信息(json bytes)
	Metadata         []byte                 `protobuf:"bytes,14,opt,name=metadata,proto3,oneof" json:"metadata,omitempty"`                                  // 日志元数据 (json bytes)
...
var file_protobuf_svc_log_proto_rawDesc = string([]byte{
	...
	0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc1, 0x04, 0x0a, 0x04, 0x4c, 0x6f, 0x67,
	...
	0x0c, 0x20, 0x01, 0x28, 0x05, 0x48, 0x00, 0x52, 0x10, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x45, 0x72, 0x72, 0x6f, 0x72, 0x43, 0x6f, 0x64, 0x65, 0x88, 0x01, 0x01, 0x12, 0x29, 0x0a, 0x0d,
	0x45, 0x78, 0x63, 0x65, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x18, 0x0d, 0x20,
	...
	0x61, 0x74, 0x61, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0c, 0x48, 0x02, 0x52, 0x08, 0x6d, 0x65, 0x74,
