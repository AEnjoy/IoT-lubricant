...
var file_protobuf_core_coreService_gateway_proto_rawDesc = string([]byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xcd, 0x05, 0x0a, 0x0a, 0x54, 0x61, 0x73, 0x6b, 0x44,
	...
	0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x42, 0x06,
...
var file_protobuf_core_coreService_gateway_proto_depIdxs = []int32{
	...
	3,  // 7: lubricant.core.Task.gatewayTryGetTaskRequest:type_name -> lubricant.core.GatewayTryGetTaskRequest
	4,  // 8: lubricant.core.Task.gatewayGetTaskResponse:type_name -> lubricant.core.GatewayGetTaskResponse
	5,  // 9: lubricant.core.Task.corePushTaskRequest:type_name -> lubricant.core.CorePushTaskRequest
	6,  // 10: lubricant.core.Task.corePushTaskResponse:type_name -> lubricant.core.CorePushTaskResponse
	7,  // 11: lubricant.core.Task.coreQueryTaskResultRequest:type_name -> lubricant.core.QueryTaskResultRequest
	7,  // 12: lubricant.core.Task.gatewayQueryTaskResultRequest:type_name -> lubricant.core.QueryTaskResultRequest
	8,  // 13: lubricant.core.Task.coreQueryTaskResultResponse:type_name -> lubricant.core.QueryTaskResultResponse
	8,  // 14: lubricant.core.Task.gatewayQueryTaskResultResponse:type_name -> lubricant.core.QueryTaskResultResponse
	2,  // 15: lubricant.core.Task.noTaskResponse:type_name -> lubricant.core.NoTaskResponse
	23, // 16: lubricant.core.Task.errorMessage:type_name -> lubricant.ErrorMessage
	0,  // 17: lubricant.core.GatewayGetTaskResponse.message:type_name -> lubricant.core.TaskDetail
	24, // 18: lubricant.core.GatewayGetTaskResponse.empty:type_name -> google.protobuf.Empty
	0,  // 19: lubricant.core.CorePushTaskRequest.message:type_name -> lubricant.core.TaskDetail
	25, // 20: lubricant.core.QueryTaskResultResponse.finish:type_name -> google.protobuf.Any
	26, // 21: lubricant.core.QueryTaskResultResponse.failed:type_name -> google.rpc.Status
	26, // 22: lubricant.core.QueryTaskResultResponse.working:type_name -> google.rpc.Status
	26, // 23: lubricant.core.QueryTaskResultResponse.pending:type_name -> google.rpc.Status
	26, // 24: lubricant.core.QueryTaskResultResponse.notFound:type_name -> google.rpc.Status
	26, // 25: lubricant.core.pushDataResponse.resp:type_name -> google.rpc.Status
	26, // 26: lubricant.core.getCoreCapacityResponse.resp:type_name -> google.rpc.Status
	23, // 27: lubricant.core.reportErrorRequest.errorMessage:type_name -> lubricant.ErrorMessage
	26, // 28: lubricant.core.reportErrorResponse.resp:type_name -> google.rpc.Status
	27, // 29: lubricant.core.coreService.ping:input_type -> lubricant.Ping
	1,  // 30: lubricant.core.coreService.getTask:input_type -> lubricant.core.Task
	9,  // 31: lubricant.core.coreService.pushMessageId:input_type -> lubricant.core.MessageIdInfo
	10, // 32: lubricant.core.coreService.pushDataStream:input_type -> lubricant.core.Data
	10, // 33: lubricant.core.coreService.pushData:input_type -> lubricant.core.Data
	12, // 34: lubricant.core.coreService.getCoreCapacity:input_type -> lubricant.core.getCoreCapacityRequest
	14, // 35: lubricant.core.coreService.reportError:input_type -> lubricant.core.reportErrorRequest
	27, // 36: lubricant.core.coreService.ping:output_type -> lubricant.Ping
	1,  // 37: lubricant.core.coreService.getTask:output_type -> lubricant.core.Task
	9,  // 38: lubricant.core.coreService.pushMessageId:output_type -> lubricant.core.MessageIdInfo
	10, // 39: lubricant.core.coreService.pushDataStream:output_type -> lubricant.core.Data
	11, // 40: lubricant.core.coreService.pushData:output_type -> lubricant.core.pushDataResponse
	13, // 41: lubricant.core.coreService.getCoreCapacity:output_type -> lubricant.core.getCoreCapacityResponse
	15, // 42: lubricant.core.coreService.reportError:output_type -> lubricant.core.reportErrorResponse
