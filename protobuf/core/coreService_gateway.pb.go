...
var file_protobuf_core_coreService_gateway_proto_rawDesc = string([]byte{
	...
	0x63, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x04, 0x72, 0x65, 0x73, 0x70, 0x32, 0x95,
	...
	0x74, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x58, 0x0a, 0x0b,
	0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x22, 0x2e, 0x6c, 0x75,
	0x62, 0x72, 0x69, 0x63, 0x61, 0x6e, 0x74, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x72, 0x65, 0x70,
	0x6f, 0x72, 0x74, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x23, 0x2e, 0x6c, 0x75, 0x62, 0x72, 0x69, 0x63, 0x61, 0x6e, 0x74, 0x2e, 0x63, 0x6f, 0x72, 0x65,
	0x2e, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x65, 0x73, 0x70,
...
var file_protobuf_core_coreService_gateway_proto_goTypes = []any{
	...
	(*gateway.StartAgentRequest)(nil),     // 16: lubricant.gateway.StartAgentRequest
	(*gateway.CreateAgentRequest)(nil),    // 17: lubricant.gateway.CreateAgentRequest
	(*gateway.EditAgentRequest)(nil),      // 18: lubricant.gateway.EditAgentRequest
	(*gateway.RemoveAgentRequest)(nil),    // 19: lubricant.gateway.RemoveAgentRequest
	(*gateway.StopAgentRequest)(nil),      // 20: lubricant.gateway.StopAgentRequest
	(*gateway.UpdateAgentRequest)(nil),    // 21: lubricant.gateway.UpdateAgentRequest
	(*gateway.GetAgentStatusRequest)(nil), // 22: lubricant.gateway.GetAgentStatusRequest
	(*gateway.StartGatherRequest)(nil),    // 23: lubricant.gateway.StartGatherRequest
	(*gateway.StopGatherRequest)(nil),     // 24: lubricant.gateway.StopGatherRequest
	(*meta.ErrorMessage)(nil),             // 25: lubricant.ErrorMessage
	(*emptypb.Empty)(nil),                 // 26: google.protobuf.Empty
	(*anypb.Any)(nil),                     // 27: google.protobuf.Any
	(*status.Status)(nil),                 // 28: google.rpc.Status
	(*meta.Ping)(nil),                     // 29: lubricant.Ping
}
var file_protobuf_core_coreService_gateway_proto_depIdxs = []int32{
	...
	22, // 6: lubricant.core.TaskDetail.getAgentStatusRequest:type_name -> lubricant.gateway.GetAgentStatusRequest
	23, // 7: lubricant.core.TaskDetail.startGatherRequest:type_name -> lubricant.gateway.StartGatherRequest
	24, // 8: lubricant.core.TaskDetail.stopGatherRequest:type_name -> lubricant.gateway.StopGatherRequest
	...
	25, // 18: lubricant.core.Task.errorMessage:type_name -> lubricant.ErrorMessage
	0,  // 19: lubricant.core.GatewayGetTaskResponse.message:type_name -> lubricant.core.TaskDetail
	26, // 20: lubricant.core.GatewayGetTaskResponse.empty:type_name -> google.protobuf.Empty
	0,  // 21: lubricant.core.CorePushTaskRequest.message:type_name -> lubricant.core.TaskDetail
	27, // 22: lubricant.core.QueryTaskResultResponse.finish:type_name -> google.protobuf.Any
	28, // 23: lubricant.core.QueryTaskResultResponse.failed:type_name -> google.rpc.Status
	28, // 24: lubricant.core.QueryTaskResultResponse.working:type_name -> google.rpc.Status
	28, // 25: lubricant.core.QueryTaskResultResponse.pending:type_name -> google.rpc.Status
	28, // 26: lubricant.core.QueryTaskResultResponse.notFound:type_name -> google.rpc.Status
	28, // 27: lubricant.core.pushDataResponse.resp:type_name -> google.rpc.Status
	28, // 28: lubricant.core.getCoreCapacityResponse.resp:type_name -> google.rpc.Status
	25, // 29: lubricant.core.reportErrorRequest.errorMessage:type_name -> lubricant.ErrorMessage
	28, // 30: lubricant.core.reportErrorResponse.resp:type_name -> google.rpc.Status
	29, // 31: lubricant.core.coreService.ping:input_type -> lubricant.Ping
	1,  // 32: lubricant.core.coreService.getTask:input_type -> lubricant.core.Task
	9,  // 33: lubricant.core.coreService.pushMessageId:input_type -> lubricant.core.MessageIdInfo
	10, // 34: lubricant.core.coreService.pushDataStream:input_type -> lubricant.core.Data
	10, // 35: lubricant.core.coreService.pushData:input_type -> lubricant.core.Data
	12, // 36: lubricant.core.coreService.getCoreCapacity:input_type -> lubricant.core.getCoreCapacityRequest
	14, // 37: lubricant.core.coreService.reportError:input_type -> lubricant.core.reportErrorRequest
	29, // 38: lubricant.core.coreService.ping:output_type -> lubricant.Ping
	1,  // 39: lubricant.core.coreService.getTask:output_type -> lubricant.core.Task
	9,  // 40: lubricant.core.coreService.pushMessageId:output_type -> lubricant.core.MessageIdInfo
	10, // 41: lubricant.core.coreService.pushDataStream:output_type -> lubricant.core.Data
	11, // 42: lubricant.core.coreService.pushData:output_type -> lubricant.core.pushDataResponse
	13, // 43: lubricant.core.coreService.getCoreCapacity:output_type -> lubricant.core.getCoreCapacityResponse
	15, // 44: lubricant.core.coreService.reportError:output_type -> lubricant.core.reportErrorResponse
