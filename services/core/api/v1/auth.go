...
import (
	...
	"github.com/AEnjoy/IoT-lubricant/services/core/api/v1/helper"
	"github.com/AEnjoy/IoT-lubricant/services/core/global"
...
func NewAuth() *Auth {
	if _auth == nil {
		_auth = &Auth{Db: ioc.Controller.Get(ioc.APP_NAME_CORE_DATABASE).(models.ICoreDb)}
	}
	return _auth
}
