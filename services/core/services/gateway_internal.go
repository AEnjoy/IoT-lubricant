...
func (s *GatewayService) AddHostInternal(ctx context.Context, info *model2.GatewayHost) error {
...
func (s *GatewayService) AddGatewayInternal(ctx context.Context, userid, gatewayid, description string, tls *crypto.Tls) error {
	...
	err := s.db.AddGateway(ctx, txn, userid, model2.Gateway{
		GatewayID:   gatewayid,
...
func (s *GatewayService) AddAgentInternal(ctx context.Context, taskid *string, gatewayid string,
	...
	var conf = model2.CreateAgentConf{AgentContainerInfo: req.AgentContainerInfo, DriverContainerInfo: req.DriverContainerInfo}
