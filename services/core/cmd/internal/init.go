...
import (
	...
	data "github.com/AEnjoy/IoT-lubricant/services/core/datastore"
	"github.com/AEnjoy/IoT-lubricant/services/core/models"
	mqService "github.com/AEnjoy/IoT-lubricant/services/core/mq"
	"github.com/AEnjoy/IoT-lubricant/services/core/router"
	service2 "github.com/AEnjoy/IoT-lubricant/services/core/services"
)
...
func AppInit() error {
	...
	once.Do(func() {
		var objects = map[string]ioc.Object{
			...
			ioc.APP_NAME_CORE_DATABASE:              &models.CoreDb{},
