...
CALLBACK_URL="http://lubricant-core.lubricant.cluster.local:8080/api/v1/signin"
USER_INFO_URL="http://lubricant-core.lubricant.cluster.local:8080/api/v1/user/info"
