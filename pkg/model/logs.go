...
type Log struct {
	...
	OperationType    svcpb.Operation       `json:"operationType" gorm:"column:operation_type;type:tinyint"`
	Cost             int64                 `json:"cost" gorm:"column:cost;type:timestamp"`
	Message          string                `json:"message" gorm:"column:message"`
	ServiceErrorCode exceptionCode.ResCode `json:"serviceErrorCode" gorm:"column:service_error_code;type:int"`
